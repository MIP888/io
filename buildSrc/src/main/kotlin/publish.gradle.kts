    ...
    publications {
        create<MavenPublication>("release") {
            ...
            pom {
                ...
                url.set("https://github.com/mip888/io/")
                ...
                scm {
                    connection.set("scm:git:git://github.com/mip888/io.git")
                    developerConnection.set("scm:git:ssh://github.com/mip888/io.git")
                    url.set("https://github.com/mip888/io/")
                }
                issueManagement {
                    system.set("GitHub Issues")
                    url.set("https://github.com/mip888/io/issues")
                }
            }
        }
    }
